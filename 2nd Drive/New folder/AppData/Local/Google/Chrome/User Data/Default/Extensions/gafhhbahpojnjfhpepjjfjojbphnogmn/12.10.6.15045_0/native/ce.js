...
var CE = (function(){
    ...
    var isInExtension = chrome && chrome.management,
                    ...
                    setLibs: {value: function(libsStr){
                        ...
                        var that = this,
                            ...
                            getLibSrc = function(lib){
                                ...
                                console1.log('xScript.setLibs.getLibSrc(%s) returns: "%s"', lib, fullSrc);
                                return fullSrc;
                            };
                ...
                HTMLElement.prototype,
                {
                    attachedCallback: {value: function(){
                        ...
                        function addStore(){
                            ...
                            li.addEventListener('contextmenu',function(e){window.contextMenuHandler(e,this)});
                            li.addEventListener('click', function(e){
                                chrome.management ? chrome.management.launchApp("ahfgeienlihckogmohjhadlkjgocpleb") : window.location = app.appLaunchUrl;
                            })
                        }
        ...
        addStylesheets = function addStyleSheets(){
            ...
            stylesheets.forEach(function(sheet){
                ...
                console.log('c: added stylesheet: %s', sheet);
            });
        },
        ...
        addContentScripts = function addContentScripts(){
            console.log('cS: in addContentScripts');
    ...
    console.log('cS: about to call addContentScripts');
    addStylesheets();
    addContentScripts();
